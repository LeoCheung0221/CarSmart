package com.cn.smart.baselib.uiframework.widgets;
...
/**
 * author: leo on 2016/7/2 0002/19:44
...
public class LazyViewPager extends ViewGroup {
    ...
    private static final int DEFAULT_OFFSCREEN_PAGES = 4;// 默认的加载页面,ViewPager是1个,所以会加载两个Fragment  为了解决卡顿问题,预加载4个页签 以后优化省流量问题请考虑此处
